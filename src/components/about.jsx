...
import resume_animation from '../assets/resume_animation.json';

export const About = () => {
    const [showAnimation, setShowAnimation] = useState(false);

    const handleViewMoreClick = () => {
      // Hide the button and show the animation
      setShowAnimation(true);
  
      // Add any additional logic or duration if needed
      setTimeout(() => {
        // Show the button again after the animation ends
        setShowAnimation(false);
      }, 1000); // Adjust the duration as per your animation's duration
    };
  return (
    <>
<Navbar isOnWork={true} />

<div className="bg-white relative   flex items-center  n justify-center overflow-hidden z-10 mt-8 ">
     
     <div className="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
         <div className="flex flex-col items-center justify-between lg:flex-row py-16">
             <div className=" relative ">
                 <div className=" absolute top-0 -left-48 z-0  opacity-50 ">
                     <img src="https://placehold.co/200x100"  alt='about' className="w-36 z-0  h-full    object-fill fill-y text-y   "/>
                 </div>
                 <div className="lg:max-w-xl lg:pr-5 relative z-40">
                     ...
                     Crafting Uniqueness
                         <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">  Your Story, Your Style</span>
                     </h2>
                     <p className="text-base text-gray-700">Hello, I'm Gulam gause, a passionate graphic designer , I bring stories to life, infusing each project with creativity and precision."</p>
                     <div className=" relative mt-10 flex flex-col items-center md:flex-row h-12">
                     {showAnimation ? (
        <Lottie
          animationData={resume_animation}
          // Add any additional Lottie props here
        ...
        <button
          ...
          className=" absoulte left-0 mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
        >
          View More
        </button>
      )}
             ...
             <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
                 ...
                 <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                      <img src="https://placehold.co/400x400"  alt='demo' />
                 </div>
             </div>
         </div>
     </div> 
...
<section className="bg-blue-50 dark:bg-slate-800" id="about-section">
